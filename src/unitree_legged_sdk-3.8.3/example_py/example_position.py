...
sys.path.append('/home/ros/unitree/src/unitree_legged_sdk-3.8.3/lib/python/arm64')    #sys.path.append('../lib/python/amd64') 
    ...
    while True:
        ...
        if( motiontime >= 0):
            ...
            if( motiontime >= 0 and motiontime < 10):
                qInit[0] = state.motorState[d['FL_0']].q
                qInit[1] = state.motorState[d['FL_1']].q
                qInit[2] = state.motorState[d['FL_2']].q
